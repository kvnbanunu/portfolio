...
export const MenuButton: React.FC<{
  ...
  return (
    <Sfx click="select">
      <button
        className={cn(
          "ml-2 sm:ml-3 2xl:ml-4 group cursor-pointer",
      ...
      >
        <div
          className={cn(
            "pb-0.5 sm:pb-1 bg-linear-to-r from-25% to-transparent",
            selected
              ? "from-gray-950"
        ...
        >
          ...
          >
            <div
              className={cn(
                "rounded-full size-6 sm:size-7 2xl:size-8 bg-radial from-10% via-30%",
                selected
            ...
            >
              <div
                className={cn(
                  "size-6 sm:size-7 2xl:size-8 justify-center items-center border-4 sm:border-5 2xl:border-6 bg-transparent",
                  selected
                    ? "border-gray-950"
            ...
            <p
              className={cn(
                "font-black self-end 2xl:text-2xl",
                selected
                  ? "text-gray-950 text-shadow-sm/30"
                  : "text-gray-400 group-hover:text-gray-950 group-hover:text-shadow-sm/30",
                textSize.title,
              )}
            >
              {label}
